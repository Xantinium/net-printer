import { CommandResult, spawn } from './utils';



const getQueue = async (completed = false, options) => {
...
export const getCompletedQueue = async (options) => getQueue(true, options);

export const getNotCompletedQueue = async (options) => getQueue(false, options);
